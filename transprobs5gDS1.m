...
%% make the figure using the "persist" version of TPs

% HCTransitionProbabilityMatsTemp = HCTransitionProbabilityMats; 
% HCTransitionProbabilityMats(:,:,1) = HCTransitionProbabilityMatsTemp(:,:,3);
% HCTransitionProbabilityMats(:,:,2) = HCTransitionProbabilityMatsTemp(:,:,4);
% HCTransitionProbabilityMats(:,:,3) = HCTransitionProbabilityMatsTemp(:,:,2);
% HCTransitionProbabilityMats(:,:,4) = HCTransitionProbabilityMatsTemp(:,:,1);
% % HCTransitionProbabilityMats(:,:,5) = HCTransitionProbabilityMatsTemp(:,:,1);
% % HCTransitionProbabilityMats(:,:,6) = HCTransitionProbabilityMatsTemp(:,:,4);
% HCTransitionProbabilityMatsTemp = HCTransitionProbabilityMats; 
% HCTransitionProbabilityMats(:,1,:) = HCTransitionProbabilityMatsTemp(:,3,:);
% HCTransitionProbabilityMats(:,2,:) = HCTransitionProbabilityMatsTemp(:,4,:);
% HCTransitionProbabilityMats(:,3,:) = HCTransitionProbabilityMatsTemp(:,2,:);
...
% % HCTransitionProbabilityMats(:,6,:) = HCTransitionProbabilityMatsTemp(:,4,:);
% % 
% clear HCTransitionProbabilityMatsTemp
% % 
% T1TransitionProbabilityMatsTemp = T1TransitionProbabilityMats; 
% T1TransitionProbabilityMats(:,:,1) = T1TransitionProbabilityMatsTemp(:,:,3);
% T1TransitionProbabilityMats(:,:,2) = T1TransitionProbabilityMatsTemp(:,:,4);
% T1TransitionProbabilityMats(:,:,3) = T1TransitionProbabilityMatsTemp(:,:,2);
% T1TransitionProbabilityMats(:,:,4) = T1TransitionProbabilityMatsTemp(:,:,1);
% % T1TransitionProbabilityMats(:,:,5) = T1TransitionProbabilityMatsTemp(:,:,1);
% % T1TransitionProbabilityMats(:,:,6) = T1TransitionProbabilityMatsTemp(:,:,4);
% T1TransitionProbabilityMatsTemp = T1TransitionProbabilityMats;
% T1TransitionProbabilityMats(:,1,:) = T1TransitionProbabilityMatsTemp(:,3,:);
% T1TransitionProbabilityMats(:,2,:) = T1TransitionProbabilityMatsTemp(:,4,:);
% T1TransitionProbabilityMats(:,3,:) = T1TransitionProbabilityMatsTemp(:,2,:);
...
% % T1TransitionProbabilityMats(:,5,:) = T1TransitionProbabilityMatsTemp(:,1,:);
% % T1TransitionProbabilityMats(:,6,:) = T1TransitionProbabilityMatsTemp(:,4,:);
% clear T1TransitionProbabilityMatsTemp
% % 
% T2TransitionProbabilityMatsTemp = T2TransitionProbabilityMats; 
% T2TransitionProbabilityMats(:,:,1) = T2TransitionProbabilityMatsTemp(:,:,3);
% T2TransitionProbabilityMats(:,:,2) = T2TransitionProbabilityMatsTemp(:,:,4);
% T2TransitionProbabilityMats(:,:,3) = T2TransitionProbabilityMatsTemp(:,:,2);
% T2TransitionProbabilityMats(:,:,4) = T2TransitionProbabilityMatsTemp(:,:,1);
% % T2TransitionProbabilityMats(:,:,5) = T2TransitionProbabilityMatsTemp(:,:,1);
% % T2TransitionProbabilityMats(:,:,6) = T2TransitionProbabilityMatsTemp(:,:,4);
% T2TransitionProbabilityMatsTemp = T2TransitionProbabilityMats;
% T2TransitionProbabilityMats(:,1,:) = T2TransitionProbabilityMatsTemp(:,3,:);
% T2TransitionProbabilityMats(:,2,:) = T2TransitionProbabilityMatsTemp(:,4,:);
% T2TransitionProbabilityMats(:,3,:) = T2TransitionProbabilityMatsTemp(:,2,:);
...
% % T2TransitionProbabilityMats(:,5,:) = T2TransitionProbabilityMatsTemp(:,1,:);
% % T2TransitionProbabilityMats(:,6,:) = T2TransitionProbabilityMatsTemp(:,4,:);
% clear T2TransitionProbabilityMatsTemp
% % 
% T3TransitionProbabilityMatsTemp = T3TransitionProbabilityMats; 
% T3TransitionProbabilityMats(:,:,1) = T3TransitionProbabilityMatsTemp(:,:,3);
% T3TransitionProbabilityMats(:,:,2) = T3TransitionProbabilityMatsTemp(:,:,4);
% T3TransitionProbabilityMats(:,:,3) = T3TransitionProbabilityMatsTemp(:,:,2);
% T3TransitionProbabilityMats(:,:,4) = T3TransitionProbabilityMatsTemp(:,:,1);
% % T3TransitionProbabilityMats(:,:,5) = T3TransitionProbabilityMatsTemp(:,:,1);
% % T3TransitionProbabilityMats(:,:,6) = T3TransitionProbabilityMatsTemp(:,:,4);
% T3TransitionProbabilityMatsTemp = T3TransitionProbabilityMats; 
% T3TransitionProbabilityMats(:,1,:) = T3TransitionProbabilityMatsTemp(:,3,:);
% T3TransitionProbabilityMats(:,2,:) = T3TransitionProbabilityMatsTemp(:,4,:);
% T3TransitionProbabilityMats(:,3,:) = T3TransitionProbabilityMatsTemp(:,2,:);
...
% % T3TransitionProbabilityMats(:,5,:) = T3TransitionProbabilityMatsTemp(:,1,:);
% % T3TransitionProbabilityMats(:,6,:) = T3TransitionProbabilityMatsTemp(:,4,:);
% clear T3TransitionProbabilityMatsTemp
% % 
% T4TransitionProbabilityMatsTemp = T4TransitionProbabilityMats; 
% T4TransitionProbabilityMats(:,:,1) = T4TransitionProbabilityMatsTemp(:,:,3);
% T4TransitionProbabilityMats(:,:,2) = T4TransitionProbabilityMatsTemp(:,:,4);
% T4TransitionProbabilityMats(:,:,3) = T4TransitionProbabilityMatsTemp(:,:,2);
% T4TransitionProbabilityMats(:,:,4) = T4TransitionProbabilityMatsTemp(:,:,1);
% % T4TransitionProbabilityMats(:,:,5) = T4TransitionProbabilityMatsTemp(:,:,1);
% % T4TransitionProbabilityMats(:,:,6) = T4TransitionProbabilityMatsTemp(:,:,4);
% T4TransitionProbabilityMatsTemp = T4TransitionProbabilityMats; 
% T4TransitionProbabilityMats(:,1,:) = T4TransitionProbabilityMatsTemp(:,3,:);
% T4TransitionProbabilityMats(:,2,:) = T4TransitionProbabilityMatsTemp(:,4,:);
% T4TransitionProbabilityMats(:,3,:) = T4TransitionProbabilityMatsTemp(:,2,:);
...
% % T4TransitionProbabilityMats(:,5,:) = T4TransitionProbabilityMatsTemp(:,1,:);
% % T4TransitionProbabilityMats(:,6,:) = T4TransitionProbabilityMatsTemp(:,4,:);
% clear T4TransitionProbabilityMatsTemp
